...
public interface IModelDeploymentStore
{
    ...
    /// </returns>
    Task<bool> DeleteAsync(ModelDeployment deployment);
    ...
    /// <returns>
    /// A task representing the asynchronous operation. The task result is the <see cref="ModelDeployment"/> if found,
    ...
    /// </returns>
    Task<ModelDeployment> FindByNameAsync(string name);
    ...
    /// <returns>
    /// A task representing the asynchronous operation. The task result is a <see cref="ModelDeploymentResult"/> object,
    ...
    /// </returns>
    Task<ModelDeploymentResult> PageAsync(int page, int pageSize, QueryContext context);
    ...
    /// </returns>
    Task SaveAsync(ModelDeployment deployment);
}
