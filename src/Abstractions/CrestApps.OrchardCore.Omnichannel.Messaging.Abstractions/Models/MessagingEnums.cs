...
/// <summary>
/// Identifies who owns an <c>MessagingConversation</c>: a single agent (a personal number) or a queue (a
/// "department" backed by an existing <c>ActivityQueue</c>).
/// </summary>
public enum ConversationOwnerType
{
    /// <summary>
...
/// <summary>
/// Describes whether an <c>MessagingConversation</c> has been picked up by an agent.
/// </summary>
public enum ConversationAssignmentStatus
{
    /// <summary>
...
/// <summary>
/// The lifecycle state of an <c>MessagingConversation</c>.
/// </summary>
...
/// </summary>
public enum ConversationRouteTargetType
{
    /// <summary>
...
/// </summary>
public enum ConversationDistributionMode
{
    /// <summary>
