...
public interface IAIChatProfileManager
{
    ...
    ValueTask<bool> DeleteAsync(AIChatProfile profile);
    ...
    /// <returns>A ValueTask that represents the asynchronous operation. The result is the AIChatProfile corresponding to the specified ID, or null if not found.</returns>
    ValueTask<AIChatProfile> FindByIdAsync(string id);
    ...
    /// <returns>A ValueTask that represents the asynchronous operation. The result is the AIChatProfile corresponding to the specified ID, or null if not found.</returns>
    ValueTask<AIChatProfile> FindByNameAsync(string name);
    ...
    /// <returns>A ValueTask that represents the asynchronous operation. The result is the newly created AIChatProfile.</returns>
    ValueTask<AIChatProfile> NewAsync(string source, JsonNode data = null);
    ...
    ValueTask<AIChatProfileResult> PageAsync(int page, int pageSize, AIChatProfileQueryContext context);
    ...
    ValueTask SaveAsync(AIChatProfile profile);
    ...
    /// <returns>A ValueTask that represents the asynchronous operation. No result is returned.</returns>
    ValueTask UpdateAsync(AIChatProfile profile, JsonNode data = null);
    ...
    ValueTask<AIChatProfileValidateResult> ValidateAsync(AIChatProfile profile);
    ...
    /// <returns>A ValueTask that represents the asynchronous operation. The result is an enumerable collection of AIChatProfile objects matching the specified type.</returns>
    ValueTask<IEnumerable<AIChatProfile>> GetAsync(AIChatProfileType type);
}
