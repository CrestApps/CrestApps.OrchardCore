...
public interface IAIChatProfileManager
{
    ...
    Task<AIChatProfileResult> PageAsync(int page, int pageSize, AIChatProfileQueryContext context);
    ...
    /// <returns>A task that represents the asynchronous operation. The result is an AIChatProfileValidateResult, which indicates whether the profile is valid or not.</returns>
