...
public interface IAIToolInstanceStore
{
    /// <summary>
    /// Asynchronously deletes a specified AI chat profile from the store.
    /// </summary>
    /// <param name="instance">The AI chat profile to delete. Must not be null.</param>
    /// <returns>
    ...
    /// </summary>
    /// <returns>
    /// A task representing the asynchronous operation. The task result is an <see cref="IEnumerable{AIToolInstance}"/>
    /// containing all AI chat profiles available in the store.
    /// </returns>
    ValueTask<IEnumerable<AIToolInstance>> GetAllAsync();
    ...
    /// <returns>
    /// A task representing the asynchronous operation. The task result is an <see cref="PageResult<AIToolInstance>"/> object,
    ...
    /// </summary>
    /// <param name="instance">The AI chat profile to save or update. Must not be null.</param>
    /// <returns>
