...
public interface IAIDeploymentStore
{
    ...
    /// </returns>
    Task<bool> DeleteAsync(AIDeployment deployment);
    ...
    /// <returns>
    /// A task representing the asynchronous operation. The task result is the <see cref="AIDeployment"/> if found,
    ...
    /// </returns>
    Task<AIDeployment> FindByNameAsync(string name);
    ...
    /// <returns>
    /// A task representing the asynchronous operation. The task result is a <see cref="AIDeploymentResult"/> object,
    ...
    /// </returns>
    Task<AIDeploymentResult> PageAsync(int page, int pageSize, QueryContext context);
    ...
    /// </returns>
    Task SaveAsync(AIDeployment deployment);
}
