...
public interface IModelManager<T>
{
    ...
    /// <summary>
    /// Asynchronously retrieves a paginated list of profiles associated with models.
    /// </summary>
    ...
    ValueTask<PageResult<T>> PageAsync(int page, int pageSize, QueryContext context);
