...
public interface IAICompletionService
{
    ...
    Task<ChatCompletion> CompleteAsync(IEnumerable<ChatMessage> messages, AICompletionContext context, CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<StreamingChatCompletionUpdate> CompleteStreamingAsync(IEnumerable<ChatMessage> messages, AICompletionContext context, CancellationToken cancellationToken = default);
}
