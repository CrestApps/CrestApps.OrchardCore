...
/// <summary>
/// The identifiers this host knows the Contact Center features by.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Named for what it holds rather than kept as a nested class on a second <c>ContactCenterConstants</c>. Two
/// classes of that name, one here and one in the extracted package, would be ambiguous in every file that
/// imports both - which is most of them. This mirrors what telephony already does with
/// <c>TelephonyFeatures</c>.
/// </para>
/// </remarks>
public static class ContactCenterFeatures
{
    /// <summary>
