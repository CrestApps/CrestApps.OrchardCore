...
/// <summary>
/// Represents the assembled, read-only flow settings for a subject type. It is composed at read time from the
/// per-type settings the host holds; it is not persisted as a catalog item.
/// </summary>
