...
/// <summary>
/// Holds the presence rules that every writer of an agent profile has to agree on: what state an agent returns
/// to when work ends, and when the idle clock runs.
/// </summary>
/// <remarks>
/// These are one-line rules, which is exactly why they are published rather than copied. Presence is written
/// from several services in several packages, and a second copy of "what does Available mean" is how an agent
/// ends up signed out by a reservation expiring.
/// </remarks>
public static class AgentPresenceUtilities
{
    /// <summary>
