...
internal static class AIPropertiesMergeHelper
{
        ...
        where TSettings : class, new()
    {
        ...
        var existingSettings = existingNode.Deserialize<TSettings>(JOptions.Default);
        ...
        var mergedSettings = mergedNode?.Deserialize<TSettings>(JOptions.Default) ?? new TSettings();
        ...
        mergedContainer[typeName] = JsonSerializer.SerializeToNode(mergedSettings, JOptions.Default);
    }
}
