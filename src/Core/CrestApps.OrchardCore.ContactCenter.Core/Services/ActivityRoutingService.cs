...
public sealed class ActivityRoutingService : IActivityRoutingService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // After the strategies, so who is next in line is judged against who can actually take the call, and so a
        // sticky or longest-idle boost cannot put an agent who just declined the call, or transferred it away, back at
        // the front while somebody else could take it.
        RepeatOfferRouting.Apply(queueItem, candidates);
    ...
    /// <summary>
    /// Whether the agent sent the queue item away, and so is offered it last.
    /// </summary>
