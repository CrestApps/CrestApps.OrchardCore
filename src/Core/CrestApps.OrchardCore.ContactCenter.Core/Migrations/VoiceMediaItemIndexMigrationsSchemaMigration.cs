...
internal sealed class VoiceMediaItemIndexMigrationsSchemaMigration : ISchemaMigration
{
    ...
    /// </remarks>
    public string Name => "VoiceMediaItemIndexMigrations";
    ...
    {
        await builder.CreateMapIndexTableAsync<VoiceMediaItemIndex>(table => table
            .Column<string>("ItemId", column => column.WithLength(26))
            .Column<string>("Name", column => column.WithLength(255)),
            collection: ContactCenterStorage.CollectionName
        );

        await builder.AlterIndexTableAsync<VoiceMediaItemIndex>(table => table
