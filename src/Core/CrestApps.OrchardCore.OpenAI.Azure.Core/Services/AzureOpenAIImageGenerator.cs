...
/// </summary>
public sealed class AzureOpenAIImageGenerator : IImageGenerator
{
    ...
    private static OpenAI.Images.ImageGenerationOptions BuildOptions(ImageGenerationOptions options)
    {
