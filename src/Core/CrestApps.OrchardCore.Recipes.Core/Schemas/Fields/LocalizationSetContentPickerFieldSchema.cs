...
/// <summary>
/// Represents the localization set content picker field schema.
/// </summary>
public sealed class LocalizationSetContentPickerFieldSchema : FieldSchemaDefinitionBase
{
    public override string Name { get; } = "LocalizationSetContentPickerField";
    ...
    protected override JsonSchemaBuilder BuildFieldSchemaCore()
        => new JsonSchemaBuilder()
            .Type(SchemaValueType.Object)
            .Properties(
                ("LocalizationSets", new JsonSchemaBuilder()
                    .Type(SchemaValueType.Array)
                    .Items(new JsonSchemaBuilder().Type(SchemaValueType.String))))
            .AdditionalProperties(true);
}
