...
public sealed class EmailTaskSchema : WorkflowActivitySchemaDefinitionBase
{
    ...
    protected override IEnumerable<(string Name, JsonSchemaBuilder Schema)> GetPropertyDefinitions()
    {
        ...
        yield return ("Body", WorkflowActivitySchemaBuilders.LiquidExpression("Deprecated. Use 'TextBody' and 'HtmlBody' instead. Reading this property returns the HTML body when 'IsHtmlBody' is true and the text body otherwise."));
        yield return ("IsHtmlBody", WorkflowActivitySchemaBuilders.Boolean("Deprecated. Use 'BodyFormat' instead. Indicates whether the deprecated 'Body' property holds HTML."));
