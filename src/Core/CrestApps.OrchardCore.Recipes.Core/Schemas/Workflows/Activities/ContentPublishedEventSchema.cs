...
/// <summary>
/// Describes the recipe schema for the <c>ContentPublishedEvent</c> workflow event.
/// </summary>
public sealed class ContentPublishedEventSchema : WorkflowActivitySchemaDefinitionBase
{
    /// <inheritdoc />
    public override string Name { get; } = "ContentPublishedEvent";

    /// <inheritdoc />
    protected override string Category => "Content";

    /// <inheritdoc />
    protected override string DisplayText => "Content Published Event";

    /// <inheritdoc />
    protected override string Description => "Triggered when a content item is published";
