...
/// <summary>
/// Describes the recipe schema for the <c>UserLoggedInEvent</c> workflow event.
/// </summary>
public sealed class UserLoggedInEventSchema : WorkflowActivitySchemaDefinitionBase
{
    /// <inheritdoc />
    public override string Name { get; } = "UserLoggedInEvent";

    /// <inheritdoc />
    protected override string Category => "User";

    /// <inheritdoc />
    protected override string DisplayText => "User Loggedin Event";

    /// <inheritdoc />
    protected override string Description => "Triggers when a user successfully logs in";
