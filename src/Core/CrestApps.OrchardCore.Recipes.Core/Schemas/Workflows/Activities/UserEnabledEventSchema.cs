...
/// <summary>
/// Describes the recipe schema for the <c>UserEnabledEvent</c> workflow event.
/// </summary>
public sealed class UserEnabledEventSchema : WorkflowActivitySchemaDefinitionBase
{
    /// <inheritdoc />
    public override string Name { get; } = "UserEnabledEvent";

    /// <inheritdoc />
    protected override string Category => "User";

    /// <inheritdoc />
    protected override string DisplayText => "User Enabled Event";

    /// <inheritdoc />
    protected override string Description => "Triggers when a user account is enabled";
