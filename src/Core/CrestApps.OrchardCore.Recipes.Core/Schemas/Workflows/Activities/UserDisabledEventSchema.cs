...
/// <summary>
/// Describes the recipe schema for the <c>UserDisabledEvent</c> workflow event.
/// </summary>
public sealed class UserDisabledEventSchema : WorkflowActivitySchemaDefinitionBase
{
    /// <inheritdoc />
    public override string Name { get; } = "UserDisabledEvent";

    /// <inheritdoc />
    protected override string Category => "User";

    /// <inheritdoc />
    protected override string DisplayText => "User Disabled Event";

    /// <inheritdoc />
    protected override string Description => "Triggers when a user account is disabled";
