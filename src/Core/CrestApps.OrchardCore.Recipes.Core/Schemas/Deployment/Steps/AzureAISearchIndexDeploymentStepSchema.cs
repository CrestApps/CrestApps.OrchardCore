...
public sealed class AzureAISearchIndexDeploymentStepSchema : DeploymentStepSchemaDefinitionBase
{
    ...
    /// <inheritdoc />
    protected override string Description => "Exports the settings of the selected Azure AI Search indexes.";
    ...
    protected override IEnumerable<(string Name, JsonSchemaBuilder Schema)> GetPropertyDefinitions(DeploymentStepSchemaContext context)
    {
        ...
        yield return ("IndexNames", DeploymentSchemaBuilders.StringArray("The names of the Azure AI Search indexes to export.", context.Examples.IndexProfileNames));
    }
}
