...
public interface ISmsConversationService
{
    ...
    Task<SmsSendResult> ClaimAsync(string conversationId, string actingAgentId, ClaimsPrincipal principal = null, CancellationToken cancellationToken = default);
    ...
    Task<SmsSendResult> AssignAsync(string conversationId, string targetAgentId, ClaimsPrincipal principal = null, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
    /// <returns>The result.</returns>
    Task<SmsSendResult> SetStatusAsync(string conversationId, SmsConversationStatus status, ClaimsPrincipal principal = null, CancellationToken cancellationToken = default);
}
