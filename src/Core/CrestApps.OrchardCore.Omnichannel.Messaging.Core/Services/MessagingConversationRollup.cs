...
/// which path wrote it.
/// </summary>
public static class MessagingConversationRollup
{
    /// <summary>
    ...
    public static void ApplyInbound(MessagingConversation conversation, string content, DateTime messageUtc, DateTime nowUtc, int unreadIncrement = 1)
    {
    ...
    /// <param name="nowUtc">The current instant.</param>
    public static void ApplyOutbound(MessagingConversation conversation, string content, DateTime messageUtc, DateTime nowUtc)
    {
        ArgumentNullException.ThrowIfNull(conversation);
