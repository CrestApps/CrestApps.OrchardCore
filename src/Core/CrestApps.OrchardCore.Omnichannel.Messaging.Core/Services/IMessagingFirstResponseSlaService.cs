...
/// supervisor.
/// </summary>
public interface IMessagingFirstResponseSlaService
{
    /// <summary>
    ...
    Task ApplyFirstResponseTargetAsync(MessagingConversation conversation, CancellationToken cancellationToken = default);

    /// <summary>
    /// Stops the clock because someone has replied.
    /// </summary>
    /// <param name="conversation">The conversation that was replied to.</param>
    void MarkResponded(MessagingConversation conversation);
