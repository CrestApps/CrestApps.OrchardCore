...
/// <summary>
/// Selects the agent a routed (push) conversation should be assigned to for a queue (department). This is
...
/// </summary>
public interface IMessagingRoutingStrategy
{
    /// <summary>
    /// Selects the best eligible agent to receive a routed conversation on the specified queue, considering
    /// queue membership, messaging availability, and per-agent concurrency.
    /// </summary>
