...
public sealed class MessagingInboundProcessor : IMessagingInboundProcessor
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Yield to the automated (AI) path while it still owns the contact and no human thread exists yet. After an
        // AI-to-human handoff the human conversation already exists, so this guard no longer trips and the
