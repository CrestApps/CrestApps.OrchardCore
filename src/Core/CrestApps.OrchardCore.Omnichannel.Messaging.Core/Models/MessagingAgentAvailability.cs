...
/// <summary>
/// Per-agent availability for <b>routed</b> (push) assignment. Stored in the agent profile's property bag so
/// it is fully independent of the agent's voice presence — an agent can accept routed conversations while signed out of
...
/// </summary>
public sealed class MessagingAgentAvailability
{
    /// <summary>
    /// The default maximum number of concurrent open, routed conversations an agent is assigned.
    /// </summary>
    public const int DefaultMaxConcurrent = 10;

    /// <summary>
    /// Gets or sets a value indicating whether the agent is accepting routed assignments.
    /// </summary>
    public bool Available { get; set; } = true;

    /// <summary>
    /// Gets or sets the maximum number of concurrent open, routed conversations to assign to the agent.
