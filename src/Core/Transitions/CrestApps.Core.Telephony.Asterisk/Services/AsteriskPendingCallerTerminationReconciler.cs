...
/// the create-lock timeout leaves no durable binding, the binding-scoped <c>AsteriskInboundReconciler</c>
...
/// </summary>
public sealed class AsteriskPendingCallerTerminationReconciler : IAsteriskProviderStateReconciler
{
