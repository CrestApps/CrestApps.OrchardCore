...
/// fail-safe in <c>AsteriskInboundCallOfferBridge</c>: it holds both the <em>termination claim</em> that makes
...
/// restart either.
/// </summary>
public interface IAsteriskPendingCallerTerminationRegistry
{
    /// <summary>
