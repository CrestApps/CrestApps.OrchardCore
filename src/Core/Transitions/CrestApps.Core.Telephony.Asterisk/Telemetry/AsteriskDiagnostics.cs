...
namespace CrestApps.Core.Telephony.Asterisk.Telemetry;
...
/// a documented migration - which is why it still reads <c>CrestApps.OrchardCore.Asterisk</c> after this code
/// moved into <c>CrestApps.Core.Telephony.Asterisk</c>: every dashboard and alert already subscribes to that
/// name. Instruments are process-wide and thread-safe by design, following the standard
