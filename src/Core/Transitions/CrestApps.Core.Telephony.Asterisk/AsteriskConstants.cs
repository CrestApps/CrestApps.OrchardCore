namespace CrestApps.Core.Telephony.Asterisk;
...
public static class AsteriskConstants
{
    ...
    /// partitioned leases and provider-command recovery survive the upgrade. That is also why it does not
    /// follow this package's namespace: a lease already written under the old key has to keep resolving.
    /// </summary>
    ...
    /// kept equal to the former feature identifier so partitioned leases survive the upgrade, and why it does
    /// not follow this package's namespace.
    /// </summary>
