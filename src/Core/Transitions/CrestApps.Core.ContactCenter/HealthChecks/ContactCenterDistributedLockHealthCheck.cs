...
/// <summary>
/// Proves the resolved <see cref="IDistributedLockProvider"/> can be acquired and released within a bounded time by
...
public sealed class ContactCenterDistributedLockHealthCheck : IHealthCheck
{
    ...
    public ContactCenterDistributedLockHealthCheck(IDistributedLockProvider distributedLock)
    {
