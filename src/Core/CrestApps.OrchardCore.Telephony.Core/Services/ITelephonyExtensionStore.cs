...
/// <summary>
/// Defines the persistence contract for internal telephony extensions.
/// </summary>
public interface ITelephonyExtensionStore : ICatalog<TelephonyExtension>
{
    /// <summary>
    /// Finds the enabled extension that owns the given dialed number.
    /// </summary>
    /// <param name="number">The dialed extension number (normalized internally).</param>
