...
Release notes for a shipped version live with that version's documentation, which you can reach from the
version picker in the top navigation. This page tracks the line that is currently in development plus the
major releases that came before it.
