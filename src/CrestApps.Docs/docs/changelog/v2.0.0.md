...
- **Liquid templates with typed objects** — Document availability and task planning templates now receive typed .NET objects (e.g., `AIToolDefinitionEntry`, `ToolRegistryEntry`, `ChatInteractionDocumentInfo`) and use Liquid loops to render tool and document lists.
