...
The matrix currently tracks 45 gates across every P0/P1 finding in the 2026-07-13 independent production-readiness review, plus the gates added by later accepted amendments: `C001`-`C008` (correctness), `D001`-`D009` (data), `F001`-`F007` (feature/package graph), `O001`-`O008` (operations), `S001`-`S006` (security), `T001`-`T003` (test/topology), and `V001`-`V004` (voice/provider).
