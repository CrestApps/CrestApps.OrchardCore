...
description: Complete reference of manifest-backed module and feature IDs documented in this repository.
---

# Feature ID Reference

This page tracks every manifest-backed **module ID** or **feature ID** declared under `src\Modules` and points to the Orchard Core docs page that covers it.
...
| `CrestApps.OrchardCore.Omnichannel.Managements` | Omnichannel Management | Feature | [Management (Mini-CRM)](./omnichannel/management) |
