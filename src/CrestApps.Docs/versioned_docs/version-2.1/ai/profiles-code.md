...
Use the Orchard docs in this repository for:

- which Orchard modules expose profile editors
- which features depend on profiles
- how profiles are surfaced in admin UI, recipes, and related Orchard modules
