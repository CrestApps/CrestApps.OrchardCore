...
| Version | Highlights |
| --- | --- |
| [2.1.5](2.1.5) | Enhanced Roles now depends on CrestApps Resources so the Role Picker editors render, CrestApps.Core moves to 1.2.1 with Docusaurus search index support, and two deprecated packages are replaced |
