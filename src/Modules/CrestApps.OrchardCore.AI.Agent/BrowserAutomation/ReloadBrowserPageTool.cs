...
public sealed class ReloadBrowserPageTool : BrowserAutomationToolBase<ReloadBrowserPageTool>
{
    public const string TheName = "reloadBrowserPage";
    ...
    public ReloadBrowserPageTool(BrowserAutomationService browserAutomationService, ILogger<ReloadBrowserPageTool> logger)
    ...
    public override string Description => "Reloads the current page.";
    ...
    protected override async ValueTask<object> InvokeCoreAsync(AIFunctionArguments arguments, CancellationToken cancellationToken)
    {
        return await ExecuteSafeAsync(TheName, async () =>
        {
            ...
            {
                var response = await trackedPage.Page.ReloadAsync(new PageReloadOptions
                {
                    Timeout = timeout,
                    WaitUntil = waitUntil,
                });
