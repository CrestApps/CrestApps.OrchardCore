...
public sealed class WaitForBrowserElementTool : BrowserAutomationToolBase<WaitForBrowserElementTool>
{
    public const string TheName = "waitForBrowserElement";
    ...
    private static readonly JsonElement _jsonSchema = JsonSerializer.Deserialize<JsonElement>(
        """
        {
          ...
          "properties": {
            ...
            "selector": {
              "type": "string",
              "description": "The Playwright selector to wait for."
            },
            "state": {
              "type": "string",
              "description": "Optional selector state: attached, detached, hidden, or visible."
            },
            "timeoutMs": {
              "type": "integer",
    ...
    public WaitForBrowserElementTool(BrowserAutomationService browserAutomationService, ILogger<WaitForBrowserElementTool> logger)
    ...
    public override string Description => "Waits for a selector to reach a requested state.";
    ...
    protected override async ValueTask<object> InvokeCoreAsync(AIFunctionArguments arguments, CancellationToken cancellationToken)
    {
        return await ExecuteSafeAsync(TheName, async () =>
        {
            ...
            var state = ParseSelectorState(arguments);
