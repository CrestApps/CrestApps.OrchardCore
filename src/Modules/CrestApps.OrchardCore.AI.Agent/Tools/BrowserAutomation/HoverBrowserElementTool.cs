...
public sealed class HoverBrowserElementTool : BrowserAutomationToolBase<HoverBrowserElementTool>
{
    public const string TheName = "hoverBrowserElement";
    ...
    public HoverBrowserElementTool(BrowserAutomationService browserAutomationService, ILogger<HoverBrowserElementTool> logger)
    ...
    public override string Description => "Moves the mouse over an element.";
