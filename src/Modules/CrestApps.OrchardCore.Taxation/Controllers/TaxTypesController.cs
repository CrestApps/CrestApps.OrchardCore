...
/// <summary>
/// Provides admin endpoints for managing <see cref="TaxType"/> entries.
/// </summary>
[Admin]
public sealed class TaxTypesController : Controller
{
    private const string _optionsSearch = "Options.Search";
    private const string _nameFieldName = "Name";

    private readonly INamedCatalogManager<TaxType> _manager;
    private readonly INamedCatalog<TaxType> _catalog;
    private readonly IAuthorizationService _authorizationService;
    private readonly IUpdateModelAccessor _updateModelAccessor;
    private readonly IDisplayManager<TaxType> _displayManager;
    ...
    public TaxTypesController(
        ...
        INamedCatalog<TaxType> catalog,
        IAuthorizationService authorizationService,
        IUpdateModelAccessor updateModelAccessor,
        IDisplayManager<TaxType> displayManager,
        INotifier notifier,
        IHtmlLocalizer<TaxTypesController> htmlLocalizer,
        IStringLocalizer<TaxTypesController> stringLocalizer)
    {
        _manager = manager;
        _catalog = catalog;
    ...
    [Admin("taxation/types", "TaxationTypesIndex")]
        ...
        [FromServices] IShapeFactory shapeFactory)
    {
        ...
        var viewModel = new ListCatalogEntryViewModel<CatalogEntryViewModel<TaxType>>
        {
            Models = [],
            Options = options,
        ...
        {
            viewModel.Models.Add(new CatalogEntryViewModel<TaxType>
            {
                Model = model,
    ...
    [Admin("taxation/types/create", "TaxationTypesCreate")]
    ...
    public async Task<IActionResult> CreatePost()
    {
        ...
        var isValid = await CatalogEntryValidation.ValidateAsync(_manager, model, _updateModelAccessor.ModelUpdater, nameof(TaxType));
        ...
        if (isValid && ModelState.IsValid)
        {
            ...
            if (existing != null)
            {
                ModelState.AddModelError(_nameFieldName, S["A tax type with the same name already exists."]);
            }

            if (ModelState.IsValid)
            {
                await _manager.CreateAsync(model);
                await _notifier.SuccessAsync(H["The tax type has been created successfully."]);
    ...
    [Admin("taxation/types/edit/{id}", "TaxationTypesEdit")]
    ...
    public async Task<IActionResult> EditPost(string id)
    {
        ...
        if (isValid && ModelState.IsValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _notifier.SuccessAsync(H["The tax type has been updated successfully."]);
    ...
    [HttpPost]
    [ActionName("Delete")]
    [Admin("taxation/types/delete/{id}", "TaxationTypesDelete")]
    public async Task<IActionResult> DeletePost(string id)
    {
        ...
        {
            await _notifier.SuccessAsync(H["The tax type has been deleted successfully."]);
        }
