...
internal sealed class ResourceManagementOptionsConfiguration : IConfigureOptions<ResourceManagementOptions>
{
    ...
    static ResourceManagementOptionsConfiguration()
    {
        ...
        _manifest
            ...
            .SetCdn(
                "https://cdn.jsdelivr.net/npm/@crestapps/ai-chat-ui@1.0.0-rc.7/dist/ai-chat.min.js",
                "https://cdn.jsdelivr.net/npm/@crestapps/ai-chat-ui@1.0.0-rc.7/dist/ai-chat.js")
            .SetCdnIntegrity(
        ...
        _manifest
            ...
            .SetCdn(
                "https://cdn.jsdelivr.net/npm/@crestapps/ai-chat-ui@1.0.0-rc.7/dist/ai-chat-widget.min.js",
                "https://cdn.jsdelivr.net/npm/@crestapps/ai-chat-ui@1.0.0-rc.7/dist/ai-chat-widget.js")
            .SetCdnIntegrity(
        ...
        _manifest
            ...
            .SetCdn(
                "https://cdn.jsdelivr.net/npm/@crestapps/ai-chat-ui@1.0.0-rc.7/dist/ai-chat.min.css",
                "https://cdn.jsdelivr.net/npm/@crestapps/ai-chat-ui@1.0.0-rc.7/dist/ai-chat.css")
            .SetCdnIntegrity(
        ...
        _manifest
            ...
            .SetCdn(
                "https://cdn.jsdelivr.net/npm/@crestapps/ai-chat-ui@1.0.0-rc.7/dist/chat-widget.min.css",
                "https://cdn.jsdelivr.net/npm/@crestapps/ai-chat-ui@1.0.0-rc.7/dist/chat-widget.css")
            .SetCdnIntegrity(
        ...
        _manifest
            .DefineStyle("AIChatTheme")
            .SetUrl("~/CrestApps.OrchardCore.AI.Chat/css/ai-chat-theme.min.css", "~/CrestApps.OrchardCore.AI.Chat/css/ai-chat-theme.css")
            .SetVersion("1.0.0");
