...
window.customChatManager = function () {
  ...
  var defaultConfig = {
    ...
    indicatorTemplate: "<div class=\"spinner-grow spinner-grow-sm\" role=\"status\"></div>"
  };
  var initialize = function initialize(instanceConfig) {
    ...
    var app = Vue.createApp({
      ...
      methods: {
              ...
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _this.connection.on("LoadSession", function (data) {
                    ...
                    _this.messages = [];
                    ((_data$messages = data.messages) !== null && _data$messages !== void 0 ? _data$messages : []).forEach(function (m) {
                      return _this.addMessage(m);
                    });
                    requestAnimationFrame(function () {
                      if (_this.inputElement) {
                        _this.inputElement.placeholder = 'How can we help you today?';
        ...
        loadSession: function loadSession(customChatInstanceId) {
          this.connection.invoke("LoadCustomChatSession", customChatInstanceId);
        },
        sendMessage: function sendMessage() {
          var text = this.prompt.trim();
          if (!text) {
            return;
          }
          this.addMessage({
        ...
        streamMessage: function streamMessage(prompt) {
          var _this2 = this;
          if (this.stream) {
            this.stream.dispose();
            this.stream = null;
          ...
          var customChatInstanceId = this.inputElement.getAttribute('data-custom-chat-instance-id');
          ...
          this.stream = this.connection.stream("SendCustomChatMessage", customChatInstanceId, prompt, sessionId).subscribe({
            next: function next(chunk) {
              return _this2.applyStreamChunk(chunk);
            },
            complete: function complete() {
              return _this2.hideTypingIndicator();
            },
        ...
        applyStreamChunk: function applyStreamChunk(chunk) {
        ...
        initDom: function initDom() {
          ...
          this.inputElement.addEventListener('input', function (e) {
            _this4.prompt = e.target.value;
            _this4.buttonElement.disabled = !_this4.prompt.trim();
          });
          this.inputElement.addEventListener('keydown', function (e) {
            if (e.key === 'Enter' && !e.shiftKey) {
              e.preventDefault();
              if (!_this4.buttonElement.disabled) {
                _this4.sendMessage();
              }
            }
          });
      ...
      mounted: function mounted() {
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          var customChatInstanceId;
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this5.startConnection();
              case 2:
                _this5.initDom();
                customChatInstanceId = _this5.inputElement.getAttribute('data-custom-chat-instance-id');
                if (customChatInstanceId) {
                  _this5.loadSession(customChatInstanceId);
                }
              case 5:
              case "end":
