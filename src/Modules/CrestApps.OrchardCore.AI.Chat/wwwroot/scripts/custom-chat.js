    ...
    var app = Vue.createApp({
      ...
      methods: {
          ...
          this.stream = this.connection.stream("SendCustomChatMessage", config.instanceId, trimmedPrompt, history).subscribe({
            next: function next(chunk) {
              ...
              if (!message) {
                ...
                messageIndex = _this3.messages.length;
                var newMessage = {
                  role: "assistant",
                  content: "",
                  htmlContent: ""
              ...
              _this3.messages[messageIndex] = message;
              _this3.scrollToBottom();
            },
            complete: function complete() {
              var _this3$messages$messa, _this3$stream;
              _this3.processReferences(references, messageIndex);
              _this3.streamingFinished();
              if (!((_this3$messages$messa = _this3.messages[messageIndex]) !== null && _this3$messages$messa !== void 0 && _this3$messages$messa.content)) {
                _this3.hideTypingIndicator();
                _this3.addMessage({
                  role: "assistant",
              ...
              (_this3$stream = _this3.stream) === null || _this3$stream === void 0 || _this3$stream.dispose();
              _this3.stream = null;
            },
            error: function error(err) {
              ...
              (_this3$stream2 = _this3.stream) === null || _this3$stream2 === void 0 || _this3$stream2.dispose();
              _this3.stream = null;
        ...
        scrollToBottom: function scrollToBottom() {
          var _this4 = this;
          setTimeout(function () {
            _this4.chatContainer.scrollTop = _this4.chatContainer.scrollHeight - _this4.chatContainer.clientHeight;
          }, 50);
        },
        ...
        initializeApp: function initializeApp() {
          ...
          this.inputElement.addEventListener('keyup', function (event) {
            if (_this5.stream != null) {
              return;
            }
            if (event.key === "Enter" && !event.shiftKey) {
              _this5.buttonElement.click();
            }
          });
          this.inputElement.addEventListener('input', function (e) {
            _this5.handleUserInput(e);
            if (e.target.value.trim()) {
              _this5.buttonElement.removeAttribute('disabled');
            } else {
              _this5.buttonElement.setAttribute('disabled', true);
            }
          });
          this.buttonElement.addEventListener('click', function () {
            if (_this5.stream != null) {
              _this5.stream.dispose();
              _this5.stream = null;
        ...
        _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this6.startConnection();
              case 2:
                _this6.initializeApp();
              case 3:
              case "end":
