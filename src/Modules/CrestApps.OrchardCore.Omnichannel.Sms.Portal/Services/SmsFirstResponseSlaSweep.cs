...
/// </remarks>
internal sealed class SmsFirstResponseSlaSweep
{
    /// <summary>
    /// The key the next pass is held under.
    /// </summary>
    internal const string DeadlineKey = "sms-first-response-sla";
    ...
    private const string LockKey = "SmsFirstResponseSlaSweep";
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SmsFirstResponseSlaSweep"/> class.
    /// </summary>
    public SmsFirstResponseSlaSweep(
    ...
    internal static Func<IServiceProvider, CancellationToken, Task<DateTime?>> CreateWork()
        => async (services, cancellationToken) => await services.GetRequiredService<SmsFirstResponseSlaSweep>().RunAsync(cancellationToken);
}
