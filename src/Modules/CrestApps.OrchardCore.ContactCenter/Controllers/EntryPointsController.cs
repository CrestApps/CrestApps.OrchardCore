...
public sealed class EntryPointsController : ContactCenterCatalogController<ContactCenterEntryPoint>
{
    ...
    /// <summary>
    /// Persists changes to a entry point.
    /// </summary>
    /// <param name="id">The entry point identifier.</param>
    /// <returns>A redirect to the list or the form when invalid.</returns>
    [HttpPost]
