...
public sealed class BusinessHoursCalendarsController : Controller
{
    ...
    private readonly IDisplayManager<BusinessHoursCalendar> _displayManager;
        ...
        [FromServices] IShapeFactory shapeFactory)
    {
        ...
        var viewModel = new ListCatalogEntryViewModel<CatalogEntryViewModel<BusinessHoursCalendar>>
        {
            Models = [],
            Options = options,
        ...
        {
            viewModel.Models.Add(new CatalogEntryViewModel<BusinessHoursCalendar>
            {
                Model = model,
    ...
    public async Task<IActionResult> Create()
    {
        ...
        {
            DisplayName = S["Business hours calendar"],
    ...
    public async Task<IActionResult> CreatePost()
    {
        ...
        var viewModel = new EditCatalogEntryViewModel
        {
            DisplayName = S["New business hours calendar"],
    ...
    public async Task<IActionResult> Delete(string id)
    {
        ...
        var calendar = await _manager.FindByIdAsync(id);

        if (calendar is not null)
        {
            await _manager.DeleteAsync(calendar);
            await _notifier.SuccessAsync(H["The business hours calendar has been deleted successfully."]);
        }
