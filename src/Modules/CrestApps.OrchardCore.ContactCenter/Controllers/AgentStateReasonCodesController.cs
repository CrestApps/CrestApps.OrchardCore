...
public sealed class AgentStateReasonCodesController : ContactCenterCatalogController<AgentStateReasonCode>
{
    ...
    protected override LocalizedString CreateDisplayName
        => S["Agent state reason code"];

    /// <inheritdoc/>
    protected override LocalizedString NewDisplayName
        => S["New agent state reason code"];

    /// <inheritdoc/>
    protected override LocalizedHtmlString CreatedNotification
        => H["A new agent state reason code has been created successfully."];

    /// <inheritdoc/>
    protected override LocalizedHtmlString UpdatedNotification
        => H["The agent state reason code has been updated successfully."];

    /// <inheritdoc/>
    protected override LocalizedHtmlString DeletedNotification
        => H["The agent state reason code has been deleted successfully."];
