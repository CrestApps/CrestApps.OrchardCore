...
public sealed class QueuesController : ContactCenterCatalogController<ActivityQueue>
{
    /// <summary>
    ...
    protected override LocalizedHtmlString CreatedNotification
        => H["A new queue has been created successfully."];

    /// <inheritdoc/>
    protected override LocalizedHtmlString UpdatedNotification
        => H["The queue has been updated successfully."];
