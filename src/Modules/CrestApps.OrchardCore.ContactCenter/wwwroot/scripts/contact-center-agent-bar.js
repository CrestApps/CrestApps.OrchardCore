...
(function (window, document) {
  ...
  function init(root) {
    ...
    function renderBar() {
      ...
      inner.innerHTML = '<div class="cc-agent-bar__top">' + renderPresence(status, reason) + renderTail() + '</div>' + '<div class="cc-bar__context" data-cc-context>' + renderContext(offer, active) + '</div>';
      bindEvents();
    }
    ...
    function renderPresence(status, reason) {
      return '<div class="cc-bar__presence" data-cc-presence>' + '<span class="cc-bar__presence-chip" title="' + escapeHtml(label('presenceReadonly', 'Change your status from the soft phone')) + '">' + '<span class="cc-bar__dot is-' + escapeHtml(status.toLowerCase()) + '"></span>' + '<span class="cc-bar__presence-label">' + escapeHtml(reason || status) + '</span>' + '</span>' + '</div>';
    }
