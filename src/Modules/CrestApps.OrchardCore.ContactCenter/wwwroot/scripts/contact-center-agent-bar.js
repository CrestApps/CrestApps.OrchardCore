...
(function (window, document) {
  ...
  function init(root) {
    ...
    function renderBar() {
      ...
      inner.innerHTML = renderPresence(status, reason) + '<div class="cc-bar__context" data-cc-context>' + renderContext(offer, active) + '</div>' + renderTail();
      bindEvents();
    }
    ...
    function renderOffer(offer) {
      ...
      return '<div class="cc-bar__offer' + (preview ? ' is-preview' : ' is-ringing') + '" data-cc-offer>' + '<div class="cc-bar__offer-info">' + '<div class="cc-bar__offer-head">' + escapeHtml(heading) + '<span class="cc-bar__countdown" data-cc-countdown></span>' + '</div>' + '<div class="cc-bar__offer-customer">' + escapeHtml(customer) + (offer.queueName ? ' <span class="cc-bar__muted">· ' + escapeHtml(offer.queueName) + '</span>' : '') + '</div>' + '</div>' + '<div class="cc-bar__offer-actions">' + '<button type="button" class="btn btn-success btn-sm" data-cc-accept><i class="fa-solid fa-phone" aria-hidden="true"></i> ' + escapeHtml(acceptLabel) + '</button>' + '<button type="button" class="btn btn-outline-danger btn-sm" data-cc-decline>' + escapeHtml(declineLabel) + '</button>' + '</div>' + '</div>';
    }
    function renderActive(active) {
      ...
      return '<div class="cc-bar__active" data-cc-active>' + '<span class="cc-bar__active-dir" title="' + escapeHtml(directionTitle) + '"><i class="fa-solid fa-phone" aria-hidden="true"></i></span>' + '<div class="cc-bar__active-info">' + '<div class="cc-bar__active-customer">' + escapeHtml(customer) + '</div>' + (ended ? '' : '<div class="cc-bar__muted">' + escapeHtml(active.status) + ' · <span data-cc-talk-time>0:00</span></div>') + '</div>' + '<div class="cc-bar__active-actions">' + (active.contactUrl ? '<a class="btn btn-outline-secondary btn-sm" href="' + escapeHtml(active.contactUrl) + '" target="_blank" rel="noopener" title="' + escapeHtml(label('openContact', 'Open customer record')) + '"><i class="fa-solid fa-address-card" aria-hidden="true"></i></a>' : '') + activityButton + '</div>' + '</div>';
    }
    function renderTail() {
