...
public sealed class AIProfileOptionsDisplayDriver : DisplayDriver<AIChatListOptions>
{
    public override IDisplayResult Edit(AIChatListOptions options, BuildEditorContext context)
    {
        return Initialize<ChatListOptionsViewModel>("AIProfileOptionsSearch_Edit", m =>
        {
