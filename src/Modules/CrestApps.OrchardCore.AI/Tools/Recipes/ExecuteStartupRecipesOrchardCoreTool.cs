...
public sealed class ExecuteStartupRecipesOrchardCoreTool : AIFunction
{
    ...
    public ExecuteStartupRecipesOrchardCoreTool(
        ...
        ILogger<ExecuteStartupRecipesOrchardCoreTool> logger)
    {
