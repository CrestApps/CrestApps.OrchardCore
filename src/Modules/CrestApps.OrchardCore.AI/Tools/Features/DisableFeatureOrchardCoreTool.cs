...
internal sealed class DisableFeatureOrchardCoreTool : AIFunction
{
    ...
    public DisableFeatureOrchardCoreTool(
    ...
    protected override async ValueTask<object> InvokeCoreAsync(AIFunctionArguments arguments, CancellationToken cancellationToken)
    {
        ...
        return $"The feature(s) were disabled successfully. {JsonSerializer.Serialize(features.Select(x => new { x.Name, x.Id, x.Dependencies, x.Category }))}";
    }
}
