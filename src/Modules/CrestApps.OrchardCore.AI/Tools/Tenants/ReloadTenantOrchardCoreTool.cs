...
public sealed class ReloadTenantOrchardCoreTool : AIFunction
{
    public const string TheName = "reloadOrchardCoreTenant";
    ...
    public ReloadTenantOrchardCoreTool(
    ...
    public override string Description => "Reloads site in a SaaS environment.";
