...
public sealed class EnableTenantOrchardCoreTool : AIFunction
{
    public const string TheName = "enableOrchardCoreTenant";
    ...
    public EnableTenantOrchardCoreTool(
    ...
    public override string Description => "Enables site in a SaaS environment.";
