    ...
    var app = Vue.createApp({
      ...
      methods: {
              ...
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _this.connection.on("StartMessageStream", function (messageId) {
                    ...
                    console.log('started message stream', messageId, !_this.messageBuffers[messageId]);
                    ...
                    if (chunk.content) {
                      ...
                      if (chunk.references && _typeof(chunk.references) === "object") {
                        for (var _i = 0, _Object$entries = Object.entries(chunk.references); _i < _Object$entries.length; _i++) {
                          ...
                          console.log('key', key, 'key', value, value.text);
                          processedContent = processedContent.replaceAll(value.text, "[".concat(value.text, "](").concat(value.link, ")"));
                        }
                      }
                  ...
                  _this.connection.on("ReceiveMessage", function (data) {
                    _this.addMessage({
                      role: data.message.role,
                      title: data.message.title,
                      content: data.message.content,
                      htmlcontent: marked.parse(data.message.content, {
                        renderer: renderer
                      })
                    });
                  });
        ...
        initializeApp: function initializeApp() {
          ...
          for (var _i2 = 0; _i2 < config.messages.length; _i2++) {
            this.addMessage(config.messages[_i2]);
          }
        },
