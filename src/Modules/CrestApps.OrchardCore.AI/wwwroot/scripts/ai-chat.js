  ...
  var initialize = function initialize(instanceConfig) {
    ...
    var app = Vue.createApp({
      ...
      methods: {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _this.connection.on("ReceiveMessageChunk", function (messageId, chunk, isFinal) {
                    _this.handleChunkedMessage(messageId, chunk, isFinal);
                  });
                  _context.prev = 2;
                  _context.next = 5;
        ...
        handleChunkedMessage: function handleChunkedMessage(messageId, chunk, isFinal) {
          ...
          var buffer = this.messageBuffers[messageId];
          ...
          var message = this.messages[buffer.messageIndex];
        ...
        sendMessage: function sendMessage() {
          ...
          var messageId = Date.now().toString(); // Unique ID for chunked handling
          this.connection.invoke("SendMessage", messageId, trimmedPrompt)["catch"](function (err) {
