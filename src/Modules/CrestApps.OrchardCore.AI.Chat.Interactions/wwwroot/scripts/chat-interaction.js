    ...
    var app = Vue.createApp({
      ...
      methods: {
        ...
        initializeApp: function initializeApp() {
          ...
          var settingsInputs = document.querySelectorAll('input[name="ChatInteraction.Title"], input[name="ChatInteraction.ConnectionName"], select[name="ChatInteraction.DeploymentId"], textarea[name="ChatInteraction.SystemMessage"], input[name="ChatInteraction.Temperature"], input[name="ChatInteraction.TopP"], input[name="ChatInteraction.FrequencyPenalty"], input[name="ChatInteraction.PresencePenalty"], input[name="ChatInteraction.MaxTokens"], input[name="ChatInteraction.PastMessagesCount"]');
        ...
        saveSettings: function saveSettings() {
          ...
          var connectionNameInput = document.querySelector('input[name="ChatInteraction.ConnectionName"]');
