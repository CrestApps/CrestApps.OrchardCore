...
internal sealed class DefaultLocalDncListManager : ILocalDncListManager
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (fileInfo == null || fileInfo.Length == 0)
            {
                ...
                await initSession.SaveAsync(list, collection: DncRegistryConstants.CollectionName, cancellationToken: cancellationToken);
        ...
        catch (Exception ex)
        {
            ...
            try
            {
                ...
                if (trackedList != null)
                {
                    ...
                    await failSession.SaveAsync(trackedList, collection: DncRegistryConstants.CollectionName, cancellationToken: cancellationToken);
                }
        ...
        try
        {
            ...
            if (trackedList != null)
            {
                ...
                await completeSession.SaveAsync(trackedList, collection: DncRegistryConstants.CollectionName, cancellationToken: cancellationToken);
            }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _session.SaveAsync(list, collection: DncRegistryConstants.CollectionName, cancellationToken: cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (trackedList.Status == LocalDncListStatus.Paused || trackedList.Status == LocalDncListStatus.Deleting)
            {
                ...
                await batchSession.SaveAsync(trackedList, collection: DncRegistryConstants.CollectionName, cancellationToken: cancellationToken);
                await batchSession.SaveChangesAsync(cancellationToken);
