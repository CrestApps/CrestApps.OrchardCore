...
/// <summary>
/// A workflow event that is raised when a wizard session is started.
/// </summary>
public sealed class WizardStartedEvent : EventActivity
{
    /// <summary>
    /// The technical name of the activity.
    /// </summary>
    public const string EventName = nameof(WizardStartedEvent);

    internal readonly IStringLocalizer S;

    /// <summary>
    /// Initializes a new instance of the <see cref="WizardStartedEvent"/> class.
    /// </summary>
    /// <param name="stringLocalizer">The string localizer.</param>
    public WizardStartedEvent(IStringLocalizer<WizardStartedEvent> stringLocalizer)
    {
        S = stringLocalizer;
    }
    ...
    /// <inheritdoc/>
    public override LocalizedString DisplayText => S["Wizard Started"];
