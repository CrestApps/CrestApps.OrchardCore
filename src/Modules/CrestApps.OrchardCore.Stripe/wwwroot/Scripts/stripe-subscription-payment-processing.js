          ...
          if (result.error) {
            ...
            fetch(config.stepIntentEndpoint, {
              ...
              var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
                var setupResult, paymentMethodId, paymentResponse, paymentData, paymentResult;
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    ...
                    case 11:
                      ...
                      _context.next = 15;
                      return fetch(config.paymentIntentEndpoint, {
                        method: 'POST',
                        headers: {
                          'Content-Type': 'application/json'
                        },
                    ...
                    case 23:
                      _context.next = 25;
                      return stripe.confirmCardPayment(paymentData.clientSecret);
                    case 25:
                    ...
                    case 30:
                      _context.next = 32;
                      return createSubscriptions(data.customerId, paymentMethodId);
                    case 32:
                      _context.next = 36;
                      break;
                    case 34:
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return fetch(config.subscriptionEndpoint, {
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json'
                  },
              ...
              case 3:
                ...
                return response.json();
              case 6:
                subscriptionDataArray = _context2.sent;
              ...
              case 10:
                _iterator = _createForOfIteratorHelper(subscriptionDataArray);
                _context2.prev = 11;
                _iterator.s();
              case 13:
                ...
                subscriptionData = _step.value;
                if (!(subscriptionData.status === 'requires_action')) {
                  _context2.next = 22;
                  break;
                }
                _context2.next = 18;
                return stripe.confirmCardPayment(subscriptionData.clientSecret);
              case 18:
