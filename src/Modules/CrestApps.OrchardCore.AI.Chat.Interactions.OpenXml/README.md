# AI Chat Interactions - OpenXml Support

This module extends the AI Chat Interactions Documents feature with Microsoft Office document support (Word, Excel, PowerPoint).
...
1. Enable the `AI Chat Interactions - OpenXml` feature in Orchard Core admin
