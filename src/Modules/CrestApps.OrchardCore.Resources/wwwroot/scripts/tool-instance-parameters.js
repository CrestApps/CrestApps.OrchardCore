...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function applyFill(row) {
      ...
      if (binding) {
        Array.from(binding.options).forEach(function (option) {
          ...
          option.title = allowed ? option.dataset.hint || option.title : 'Not available when this parameter is filled by ' + value.toLowerCase() + '.';
    ...
    function updatePreview() {
      ...
      notes.push(modelSees.length > 0 ? 'The model fills: ' + modelSees.join(', ') : 'The model fills no declared parameters.');
      if (previewNotes) {
