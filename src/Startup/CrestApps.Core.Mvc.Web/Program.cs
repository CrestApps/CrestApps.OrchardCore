...
builder.Services.Configure<IndexProfileSourceOptions>(options =>
    options.AddOrUpdate(CrestApps.Core.Elasticsearch.ServiceCollectionExtensions.ProviderName, "Elasticsearch", IndexProfileTypes.Articles, descriptor =>
    {
...
builder.Services.Configure<IndexProfileSourceOptions>(options =>
    options.AddOrUpdate(CrestApps.Core.Azure.AISearch.ServiceCollectionExtensions.ProviderName, "Azure AI Search", IndexProfileTypes.Articles, descriptor =>
    {
        descriptor.DisplayName = "Articles";
