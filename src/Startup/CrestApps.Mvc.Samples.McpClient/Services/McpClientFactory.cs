...
namespace CrestApps.Mvc.Samples.McpClient.Services;
...
public sealed class McpClientFactory
{
    ...
    public async Task<ModelContextProtocol.Client.McpClient> CreateAsync(CancellationToken cancellationToken)
    {
        ...
        var clientOptions = new McpClientOptions
        {
            ...
            {
                Name = "CrestApps.Mvc.Samples.McpClient",
                Version = "1.0.0",
            },
        };
        ...
        catch (HttpRequestException ex) when (ex.StatusCode == System.Net.HttpStatusCode.NotFound)
        {
            throw new InvalidOperationException(
                ...
                "Please ensure the MCP Server feature is enabled on the CrestApps.Mvc.Web application.", ex);
        }
    }
}
