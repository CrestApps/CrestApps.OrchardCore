  ...
  docsSidebar: [
    ...
    'getting-started',
    {
      ...
      items: [
        ...
        'framework/ai-templates',
        'framework/tools',
        'framework/agents',
        'framework/copilot',
        'framework/response-handlers',
        'framework/context-builders',
        'framework/signalr',
        'framework/data-storage',
        'framework/ai-documents',
        'framework/ai-memory',
        'framework/interfaces',
        {
          ...
          label: 'AI Providers',
          items: [
            'framework/providers/index',
            'framework/providers/openai',
            'framework/providers/azure-openai',
            'framework/providers/ollama',
            'framework/providers/azure-ai-inference',
          ],
        },
        {
          type: 'category',
          label: 'Data Sources',
          items: [
            'framework/data-sources/index',
            'framework/data-sources/elasticsearch',
            'framework/data-sources/azure-ai',
          ],
        },
        {
          type: 'category',
