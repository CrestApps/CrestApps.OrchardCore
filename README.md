...
* If you're using Orchard Core versions from `2.1` up to `3.0.0-preview-18659`, please use package version `2.0.0-beta-0001`.
* For Orchard Core `3.0.0-preview-18660` and later, use version `1.2.0-beta-0014` or newer.
