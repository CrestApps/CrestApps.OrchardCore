...
public sealed class DataSourceVectorSearchFilterTests
{
    ...
    public void AzureAISearch_BuildODataFilter_AlwaysIncludesDataSourceId()
    {
        var serviceType = Type.GetType(
            "CrestApps.AI.DataSources.AzureAI.Services.AzureAISearchDataSourceContentManager, CrestApps.AI.DataSources.AzureAI",
            throwOnError: true);
    ...
    {
        var serviceType = Type.GetType(
            "CrestApps.AI.DataSources.Elasticsearch.Services.ElasticsearchDataSourceContentManager, CrestApps.AI.DataSources.Elasticsearch",
            throwOnError: true);
