...
public sealed class MigrationAdditiveOnlyGuardTests
{
    ...
    [
        ...
        new MigrationContractEntry(
            ...
            "2.0.0",
            null,
            "Denormalized creator display column that shipped in stable 2.0.0 and is dropped in 3.0.0; the value is rehydrated from the related user record on read, so a customer upgrading from 2.0.0 keeps every attribution."),
        new MigrationContractEntry(
            ...
            "2.0.0",
            null,
            "Index over the redundant national cell-phone column that shipped in stable 2.0.0; it is dropped in 3.0.0 alongside the column it covered, whose normalized value is recomputed on read."),
        new MigrationContractEntry(
            "src/Modules/CrestApps.OrchardCore.Omnichannel.Managements/Migrations/OmnichannelContactsMigrations.cs",
            "OmnichannelContactsMigrations",
            "RemoveRedundantNationalPhoneColumnsAsync",
            ...
            "2.0.0",
            null,
            "Index over the redundant national home-phone column that shipped in stable 2.0.0; it is dropped in 3.0.0 alongside the column it covered, whose normalized value is recomputed on read."),
        new MigrationContractEntry(
            "src/Modules/CrestApps.OrchardCore.Omnichannel.Managements/Migrations/OmnichannelContactsMigrations.cs",
            "OmnichannelContactsMigrations",
            "RemoveRedundantNationalPhoneColumnsAsync",
            ...
            "2.0.0",
            null,
            "Redundant normalized cell-phone column that shipped in stable 2.0.0 and is dropped in 3.0.0; the normalized value is recomputed from the raw number on read, so a customer upgrading from 2.0.0 loses nothing."),
        new MigrationContractEntry(
            "src/Modules/CrestApps.OrchardCore.Omnichannel.Managements/Migrations/OmnichannelContactsMigrations.cs",
            "OmnichannelContactsMigrations",
            "RemoveRedundantNationalPhoneColumnsAsync",
            ...
            "2.0.0",
            null,
            "Redundant normalized home-phone column that shipped in stable 2.0.0 and is dropped in 3.0.0; the normalized value is recomputed from the raw number on read, so a customer upgrading from 2.0.0 loses nothing."),
        new MigrationContractEntry(
            "src/Modules/CrestApps.OrchardCore.Omnichannel.Managements/Migrations/OmnichannelContactsMigrations.cs",
            "OmnichannelContactsMigrations",
            ...
            "2.0.0",
            null,
            "Superseded phone index table that shipped in stable 2.0.0 and is dropped in 3.0.0 after its data is folded into the current contact index, so a customer upgrading from 2.0.0 keeps every phone lookup."),
        new MigrationContractEntry(
            "src/Modules/CrestApps.OrchardCore.Omnichannel.Managements/Migrations/OmnichannelContactsMigrations.cs",
            "OmnichannelContactsMigrations",
