...
public sealed class FileSizeRatchetTests
{
    ...
    private static readonly Dictionary<string, int> _existing = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["src/Modules/CrestApps.OrchardCore.ContactCenter/Reports/Providers/EnterpriseInteractionReportProvider.cs"] = 1250,
        ["src/Core/CrestApps.OrchardCore.ContactCenter.Core/Services/ContactCenterReportingService.cs"] = 923,
        ["src/Core/CrestApps.OrchardCore.ContactCenter.Core/Services/ProviderVoiceEventService.cs"] = 937,
