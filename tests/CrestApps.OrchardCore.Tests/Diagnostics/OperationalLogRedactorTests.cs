...
public sealed class OperationalLogRedactorTests
{
    ...
    {
        // Act
        var first = OperationalLogRedactor.Pseudonymize("user-123", OperationalLogIdentifierCategory.User);
        var second = OperationalLogRedactor.Pseudonymize("user-456", OperationalLogIdentifierCategory.User);
    ...
    {
        // Arrange
        const string withControlCharacters = "user-123\r\n";
        const string withoutControlCharacters = "user-123";

        // Act
        var first = OperationalLogRedactor.Pseudonymize(withControlCharacters, OperationalLogIdentifierCategory.User);
        var second = OperationalLogRedactor.Pseudonymize(withoutControlCharacters, OperationalLogIdentifierCategory.User);
