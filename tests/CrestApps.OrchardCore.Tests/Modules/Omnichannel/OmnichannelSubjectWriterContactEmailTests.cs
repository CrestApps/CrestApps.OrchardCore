...
public sealed class OmnichannelSubjectWriterContactEmailTests
{
    ...
    public void TryApplyContactEmail_AddsEmailAddressItem_WhenNoneExists()
    {
        ...
        var changed = OmnichannelSubjectWriter.TryApplyContactEmail(contact, "buyer@example.com");
    ...
    {
        var contact = CreateContactWithPhone("+17024993350");
        Assert.True(OmnichannelSubjectWriter.TryApplyContactEmail(contact, "old@example.com"));

        var changed = OmnichannelSubjectWriter.TryApplyContactEmail(contact, "new@example.com");
    ...
    {
        var contact = CreateContactWithPhone("+17024993350");
        Assert.True(OmnichannelSubjectWriter.TryApplyContactEmail(contact, "buyer@example.com"));

        // A second call with the same address (any casing) is a no-op.
        Assert.False(OmnichannelSubjectWriter.TryApplyContactEmail(contact, "BUYER@example.com"));
    ...
    public void TryApplyContactEmail_ReturnsFalse_ForInvalidInput(string email)
    {
        ...
        var changed = OmnichannelSubjectWriter.TryApplyContactEmail(contact, email);
