...
public sealed class AutomatedConversationGateTests
{
    ...
    {
        var gate = new InMemoryAutomatedConversationGate(TimeProvider.System);
    ...
    public void TwoGates_DoNotShareState()
    {
        ...
        var first = new InMemoryAutomatedConversationGate(TimeProvider.System);
        var second = new InMemoryAutomatedConversationGate(TimeProvider.System);
