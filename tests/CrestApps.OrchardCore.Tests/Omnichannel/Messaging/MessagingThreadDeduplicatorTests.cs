...
/// </summary>
public sealed class MessagingThreadDeduplicatorTests
{
    ...
    public void Collapse_DropsTheHandoffCopy_OfAnInboundMessageTheThreadAlreadyHolds()
    {
        ...
        // Act
        var collapsed = MessagingThreadDeduplicator.Collapse([live, copy, reply]);
    ...
    public void Collapse_DropsTheCopy_WhenItSortsBeforeTheLiveRow()
    {
        ...
        // Act
        var collapsed = MessagingThreadDeduplicator.Collapse([copy, live]);
    ...
    public void Collapse_KeepsTwoGenuineTexts_WithTheSameWords()
    {
        ...
        // Act
        var collapsed = MessagingThreadDeduplicator.Collapse([first, second]);
    ...
    public void Collapse_KeepsAnInboundCopy_ThatHasNoLiveTwin()
    {
        ...
        // Act
        var collapsed = MessagingThreadDeduplicator.Collapse([copy, later]);
    ...
    public void Collapse_FoldsNoMoreCopiesThanThereAreLiveRows()
    {
        ...
        // Act
        var collapsed = MessagingThreadDeduplicator.Collapse([live, firstCopy, secondCopy]);
    ...
    public void Collapse_NeverFoldsAnAutomatedReply_IntoTheCustomersText()
    {
        ...
        // Act
        var collapsed = MessagingThreadDeduplicator.Collapse([live, reply]);
    ...
    public void Collapse_DropsARedeliveredRow_WithTheSameProviderMessageId()
    {
        ...
        // Act
        var collapsed = MessagingThreadDeduplicator.Collapse([first, redelivered]);
    ...
    public void Collapse_DropsARepeatedCopy_OfTheSameTranscriptEntry()
    {
        ...
        // Act
        var collapsed = MessagingThreadDeduplicator.Collapse([first, replayed]);
