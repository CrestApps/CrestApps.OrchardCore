...
public class SmsAgentAvailabilityServiceTests
{
    ...
    public void Get_DefaultsToAvailable_WhenUnset()
    {
        ...
        Assert.Equal(MessagingAgentAvailability.DefaultMaxConcurrent, availability.EffectiveMaxConcurrent);
    }
    ...
    private sealed class Harness
    {
        ...
        public MessagingAvailabilityService Service { get; }
        ...
        public Harness()
        {
            ...
            Service = new MessagingAvailabilityService(
                AgentManager.Object,
                new Mock<IMessagingPresenceTracker>().Object,
                clock.Object);
        }
    }
    ...
    private sealed class AvailabilityHarness
    {
        ...
        public AvailabilityHarness(AgentProfile agent, bool portalOpen)
        {
            ...
            var presenceTracker = new Mock<IMessagingPresenceTracker>();
            presenceTracker
