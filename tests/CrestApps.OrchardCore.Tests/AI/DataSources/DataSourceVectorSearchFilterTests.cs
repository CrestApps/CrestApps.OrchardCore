...
public sealed class DataSourceVectorSearchFilterTests
{
    ...
    public void AzureAISearch_BuildODataFilter_AlwaysIncludesDataSourceId()
    {
        var serviceType = Type.GetType(
            "CrestApps.OrchardCore.AI.DataSources.AzureAI.Services.DataSourceAzureAISearchVectorSearchService, CrestApps.OrchardCore.AI.DataSources.AzureAI",
            throwOnError: true);
    ...
    {
        var serviceType = Type.GetType(
            "CrestApps.OrchardCore.AI.DataSources.Elasticsearch.Services.DataSourceElasticsearchVectorSearchService, CrestApps.OrchardCore.AI.DataSources.Elasticsearch",
            throwOnError: true);
