...
- [~] Phase 3 — Routing MVP (availability + priority + required-skills filtering + capacity enforcement + longest-idle assignment + auditable routing decision events shipped; sticky-agent and business-hours strategies pending)
